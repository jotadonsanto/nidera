...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-bold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-80",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow hover:bg-primary/90 disabled:text-white disabled:bg-gray-400 disabled:opacity-100",
        secondary:
        ...
        ghost: "hover:bg-neutral-100 hover:text-accent-foreground border border-primary bg-white",
